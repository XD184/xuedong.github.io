...
<div style="display: flex; align-items: flex-start; gap: 25px; margin-bottom: 35px; position: relative;">
  ...
  <li> one follow up paper on detailed parameter study: 120-fs single-pulse generation from stretched-pulse fiber Kerr resonators   
      <strong>Xue Dong</strong>, Zhiqiang Wang, William Renninger <em> Optics Letters 2022</em></ul>
    </div>
